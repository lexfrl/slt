...
var Slots = (function () {
    function Slots() {
        ...
        var promiseClass = arguments[3] === undefined ? null : arguments[3];
        ...
        this.contexts = [];
        this.listeners = {};
        this.promiseClass = promiseClass || _coreJsEs6Promise2["default"] || null;
    }
    ...
    _createClass(Slots, [{
        ...
        value: function promise() {
            ...
            var promiseClass = arguments[0] === undefined ? null : arguments[0];
            ...
            return new promiseClass(function (resolve, reject) {
                _this2.allDone(function (err, state) {
                    if (err) {
